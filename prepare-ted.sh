...
SRC_LANG=$1
TGT_LANG=$2
WORKING_DIR="./ted-staging"
INPUT_DIR="./xml"
OUTPUT_DIR="./ted-clean"
SCRIPT_DIR="./processing-tools"

echo "Translating from ${SRC_LANG} to ${TGT_LANG} ..."
...
perl $SCRIPT_DIR/find-common-talks.pl \
...
perl $SCRIPT_DIR/filter-talks.pl \
...
perl $SCRIPT_DIR/ted-extract-par.pl \
...
perl $SCRIPT_DIR/ted-extract-mono.pl \
        --xml $TED_TRAIN_TGT \
...
perl $SCRIPT_DIR/rebuild-sent.pl \
