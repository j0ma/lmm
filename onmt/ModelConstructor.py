...
import onmt.Models
import onmt.modules
from onmt.Models import NMTModel, NMTSourceTrigramModel, NMTTargetCharModel, CharNMTModel, MeanEncoder, RNNEncoder, \
...
def make_decoder(opt, embeddings):
    ...
    # NOTE: THIS IS WHAT GETS TRIGGERED IN DEFAULT EXPERIMENTS
        ...
        return [StdWordRNNDecoder(opt.rnn_type, opt.brnn,
                                   ...
                                   embeddings,
                                   opt.reuse_copy_attn),
                StdCharRNNDecoder(opt.rnn_type, opt.brnn,
                                   opt.dec_layers, opt.rnn_size,
                                   opt.global_attention,
                                   opt.coverage_attn,
                                   opt.context_gate,
...
def load_test_model(opt, dummy_opt):
    ...
    fields = onmt.io.load_fields_from_vocab(
        checkpoint['vocab'], data_type=opt.src_data_type)
